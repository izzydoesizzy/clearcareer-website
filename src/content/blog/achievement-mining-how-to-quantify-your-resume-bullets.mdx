...
X = Grew following from 12K to 89K.<br />
Y = 1,400 inbound leads per quarter.<br />
...
Would things have fallen apart?<br />
Would deadlines have been missed?<br />
Would errors have gone uncaught?<br />
...
<CoachBubble>Okay. Was it more than 20?</CoachBubble>
...
<ChatNarration>So: 24 packs times $14 times 200,000 additional units = **$67 million in additional revenue.** David was stunned. He had no idea the number was that big.</ChatNarration>
...
The XYZ formula unlocked the whole thing.<br />
X = grew team by 50%.<br />
Y = 5 new agents.<br />
...
<CoachBubble>How often did you run the company socials?</CoachBubble>

<ClientBubble>Monthly.</ClientBubble>

<CoachBubble>How many people attended?</CoachBubble>

<ClientBubble>About 30.</ClientBubble>

<CoachBubble>What was the attendance rate?</CoachBubble>

<ClientBubble>80%.</ClientBubble>

<CoachBubble>What was the budget?</CoachBubble>

<ClientBubble>$50 per person.</ClientBubble>

<CoachBubble>When did you launch them?</CoachBubble>

<ClientBubble>Within the first four weeks on the job.</ClientBubble>

<CoachBubble>What broader impact did they have?</CoachBubble>

<ClientBubble>They contributed to the success of the company's hybrid work model.</ClientBubble>
...
Then, for each job you apply to, select the 3 to 5 most relevant achievements for that specific role. Tools like [Teal](https://get.tealhq.com/k4R9Mv) (the free version) let you toggle achievements on and off for different applications without rewriting from scratch.
...
If you want someone to sit across from you and dig these numbers out through real coaching conversations, that's exactly what happens inside the [Job Search Ignition System](/programs/jsis). Every client walks out with a resume full of quantified achievements they didn't know they had. Check out our [free career tools](/tools) for templates and frameworks to start the process on your own.

> **Want the complete guide?** This playbook is the quick version. For the full deep-dive with 10 copy-paste AI prompts, estimation strategies, edge-case solutions, and a 7-day action plan, check out [Make It Count: The Complete Guide to Quantifying Your Career Impact](/blog/make-it-count-quantify-your-career-impact).
