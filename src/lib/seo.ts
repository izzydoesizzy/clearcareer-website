export function generateWebsiteSchema() {
  return {
    ...
    description:
      "Career coaching and job search accelerator helping professionals land roles faster with higher salaries.",
    potentialAction: {
      "@type": "SearchAction",
...
export function generateOrganizationSchema() {
  return {
    ...
    description:
      "Career coaching and job search accelerator. 200+ professionals coached, $1.2M+ in collective raises.",
    founder: {
      "@type": "Person",
      name: 'Iskender "Izzy" Piyale-Sheard',
    },
...
export function generateCourseSchema() {
  return {
    ...
    description:
      "An 8-week done-with-you job search accelerator for senior professionals targeting $100K+ roles. Includes AI-powered career toolkit, resume writing, LinkedIn optimization, and salary negotiation coaching.",
    provider: {
      "@type": "Organization",
      name: "ClearCareer",
      url: "https://joinclearcareer.com",
